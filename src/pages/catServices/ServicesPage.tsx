...
const SERVICES = [
  {
    ...
    tag: 'Más solicitado',
    description:
      'Transformamos tu día especial en un jardín de ensueño. Desde el arco nupcial hasta la última mesa, cada detalle cuenta una historia de amor.',
    includes: [
      'Arco o altar floral personalizado',
      'Decoración de mesas y centros florales',
      'Ramo de novia y boutonnière',
      'Flores para damas y padrinos',
      'Consulta previa y moodboard',
    ],
  },
  {
    id: 2,
    name: 'Ramo de Novia Personalizado',
    category: 'Bodas',
    scale: 'Pequeño',
    image: floridos2,
    tag: null,
    description:
      'Tu ramo es el accesorio más importante del día. Lo diseñamos contigo, flor por flor, para que sea exactamente lo que soñaste.',
    includes: [
      'Consulta de estilo y paleta de colores',
      'Selección de flores de temporada',
      'Ramo principal + boutonnière a juego',
      'Entrega el día del evento',
    ],
  },
  {
    id: 3,
    ...
    tag: null,
    description:
      'Eleva la imagen de tu empresa con arreglos florales que impresionan. Desde lanzamientos de producto hasta galas anuales.',
    includes: [
      'Centros de mesa para salones de eventos',
      'Arreglos para lobby y recepción',
      'Decoración de escenarios y tarimas',
      'Coordinación el día del evento',
    ],
  },
  {
    id: 4,
    name: 'Suscripción Floral Semanal',
    category: 'Suscripción',
    scale: 'Recurrente',
    image: floridos4,
    tag: 'Novedad',
    description:
      'Flores frescas en tu hogar u oficina cada semana. Elige tu estilo una vez y nosotros hacemos el resto — siempre con lo mejor de la temporada.',
    includes: [
      'Arreglo fresco cada 7 o 14 días',
      'Elección de estilo: romántico, silvestre o minimalista',
  ...
  {
    id: 5,
    name: 'Quinceañeras & Celebraciones',
    category: 'Celebración',
    scale: 'Grande',
    image: floridos5,
    tag: null,
    description:
      'Un cumpleaños, una quinceañera, un grado — cada celebración merece flores que lo hagan inolvidable. Diseñamos la atmósfera completa.',
    includes: [
      'Decoración del salón completo',
      'Corona floral o tocado',
      'Bouquet y accesorios florales',
      'Mesa principal y de dulces',
    ],
  },
  {
    id: 6,
    name: 'Arreglos de Simpatía',
    category: 'Simpatía',
    scale: 'Mediano',
    image: floridos6,
    tag: null,
    description:
      'En los momentos más difíciles, las flores dicen lo que las palabras no pueden. Preparamos arreglos con delicadeza y entrega oportuna.',
    includes: [
      'Corona fúnebre o arreglo de condolencias',
      'Mensaje personalizado incluido',
      'Entrega urgente disponible',
      'Discreción y acompañamiento',
    ],
  },
  {
    id: 7,
    name: 'Espacios Comerciales & Oficinas',
    category: 'Corporativo',
    scale: 'Mediano',
    image: floridos7,
    tag: null,
    description:
      'Una recepción con plantas bien diseñadas comunica cuidado y profesionalismo. Asesoramos, instalamos y renovamos tu espacio verde.',
    includes: [
      'Asesoría de espacios y selección de plantas',
      'Instalación y macetería decorativa',
      'Renovación mensual o bimensual',
      'Mantenimiento opcional incluido',
    ],
  },
  {
    id: 8,
    name: 'Regalo Sorpresa Personalizado',
    category: 'Regalo',
    scale: 'Pequeño',
    image: floridos8,
    tag: null,
    description:
      'Cuando quieres sorprender de verdad. Diseñamos una experiencia completa: flores, mensaje y presentación para que el momento sea perfecto.',
    includes: [
      'Caja o empaque premium personalizado',
      'Carta manuscrita o tarjeta',
      'Flores o planta a elección',
      'Entrega sorpresa con coordinación',
    ],
  },
  {
    id: 9,
    name: 'Decoración para Baby Shower',
    category: 'Celebración',
    scale: 'Mediano',
    image: floridos9,
    tag: null,
    description:
      'La llegada de una nueva vida merece un ambiente lleno de suavidad y color. Creamos decoraciones florales que hacen el momento aún más especial.',
    includes: [
      'Arco floral para fotos',
      'Centros de mesa temáticos',
      'Mesa de honor decorada',
      'Globos y flores coordinadas',
    ],
  },
];
...
const QuoteModal = ({
  ...
  const handleSubmit = () => {
    ...
    const msg = [
      `🌸 *Solicitud de Cotización — Floridos*`,
      ``,
    ...
    const url = `https://wa.me/573146890813?text=${encodeURIComponent(msg)}`;
        ...
        {!sent ? (
          <>
            <div className="modal-header">
              ...
              <p className="modal-desc">
                Cuéntanos un poco sobre lo que necesitas y te contactamos con una propuesta personalizada.
              </p>
            </div>
            ...
            <div className="modal-body">
              ...
              <div className="form-group">
                ...
                <textarea
                  rows={3}
                  placeholder="Número de personas, estilo que tienes en mente, colores, presupuesto aproximado..."
                  value={form.message}
              ...
              <div className="modal-includes">
                ...
                <ul>
                  {service.includes.map((item, i) => (
                    <li key={i}><FaCheck size={9} />{item}</li>
                  ))}
                </ul>
              </div>
            </div>
          ...
          <div className="modal-success">
            ...
            <p>
              ...
              <a href={`https://wa.me/573146890813`} target="_blank" rel="noreferrer">
                haz clic aquí
              </a>
              .
            </p>
...
const ServiceCard = ({
  ...
  onQuote: (s: typeof SERVICES[0]) => void;
}) => (
    ...
    <div className="service-body">
      ...
      <ul className="service-includes">
        ...
        {service.includes.length > 3 && (
          <li className="includes-more">+{service.includes.length - 3} más incluidos</li>
        )}
      </ul>
    </div>

    <div className="service-footer">
      <span className="service-cta-hint">
        <MdOutlineFormatQuote size={14} /> Precio según tu proyecto
      </span>
      <button className="btn-quote" onClick={() => onQuote(service)}>
          ...
          <div className="services-content">
            ...
            <main className="services-main">
              ...
              <div className="services-toolbar">
                ...
                <span className="results-count">{filtered.length} {filtered.length === 1 ? 'servicio' : 'servicios'}</span>
              </div>

              {filtered.length === 0 ? (
                <div className="no-results">
                  <p>No se encontraron servicios con los filtros seleccionados.</p>
                  <button className="btn-clear" onClick={clearAllFilters}>Limpiar filtros</button>
                </div>
              ) : (
                <div className="services-grid">
                  {filtered.map(s => (
                    <ServiceCard key={s.id} service={s} onQuote={setActiveService} />
                  ))}
                </div>
              )}
